...
```text
docs/testing/
├── README.md                 # Testing guidelines, standards & quality gates
...
└── session-reports/          # Historical audit logs and verification run summaries
```
...
> **Rule:** Never equate *"no visible error"* with *"correct"*.
...
## Status
PASS / PASS WITH KNOWN LIMITATIONS / FAIL / BLOCKED / NOT VERIFIED
