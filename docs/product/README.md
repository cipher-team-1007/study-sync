...
=======
Welcome to the Product Documentation directory for **StudySync**. This space is owned and managed by **Product Mode Agent**.
...
2. **SHARE:** Generate and copy a shareable room link.
